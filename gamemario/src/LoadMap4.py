...
class LoadMap4(BaseMapLevel):
    def __init__(self, character_folder="Pink Man"):
        super().__init__(map_name="Map4.tmx", next_level_class=None, character_folder=character_folder)
    ...
    def on_update(self, delta_time):
        ...
        if self.is_switching_level:
            ...
            if self.next_level_timer >= 0.8:
                next_view = WinView(current_map="Map4", character_folder=self.character_folder)
